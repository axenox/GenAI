...
class OpenAiConnector extends AbstractDataConnector implements AiConnectorInterface
{
    ...
    private $dryrunResponse = "This is an pregenerated demo response because the AI connector has `dryrun:true`. This was not really generated by an LLM! See debug info below.";
     ...
     * @uxon-type string|object|array
     * @uxon-default This is an pregenerated demo response because the AI connector has `dryrun:true`. Change it to any string or JSON object in the connection config.
     *
     * @param string|array|UxonObject $value
     * @return OpenAiConnector
     */
    protected function setDryrunResponse(string|array|UxonObject $value) : OpenAiConnector
    {
        switch (true) {
            case $value instanceof UxonObject:
                $this->dryrunResponse = $value->toJson();
                break;
            case is_array($value):
                $this->dryrunResponse = JsonDataType::encodeJson($value);
                break;
            default:
