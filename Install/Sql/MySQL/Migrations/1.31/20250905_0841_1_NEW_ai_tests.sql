...
CREATE TABLE IF NOT EXISTS`exf_ai_test_criterion` (
    ...
    CONSTRAINT `exf_ai_test_criterion_test_case` FOREIGN KEY (`ai_test_case_oid`) REFERENCES `exf_ai_test_case` (`oid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `exf_ai_test_result` (
    ...
    CONSTRAINT `exf_ai_test_result_test_run` FOREIGN KEY (`ai_test_run_oid`) REFERENCES `exf_ai_test_run` (`oid`),
    CONSTRAINT `exf_ai_test_result_test_criterion` FOREIGN KEY (`ai_test_criterion_oid`) REFERENCES `exf_ai_test_criterion` (`oid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `exf_ai_test_run` (
    ...
    CONSTRAINT `exf_ai_test_run_test_case` FOREIGN KEY (`ai_test_case_oid`) REFERENCES `exf_ai_test_case` (`oid`),
    CONSTRAINT `exf_ai_test_run_conversation` FOREIGN KEY (`ai_conversation_oid`) REFERENCES `exf_ai_conversation` (`oid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
