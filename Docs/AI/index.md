...
The `axenox.GenAI` app provides the standard tools and concepts documented here. Other apps can provide additional tool and concept prototypes for their own domains and workflows.
